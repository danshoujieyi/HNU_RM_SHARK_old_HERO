...
/* ---------------------------------- 底盘相关 ---------------------------------- */
/* 底盘轮距(mm) */
#define WHEELTRACK        469
/* 底盘轴距(mm) */
#define WHEELBASE         462
/* 底盘轮子周长(mm) */
#define WHEEL_PERIMETER   478

#define LENGTH_A 310 //底盘长的一半(mm)
#define LENGTH_B 275 //底盘宽的一半(mm)
...
// TODO: 参数待整定
/* 跟随云台PID */
#define CHASSIS_KP_V_FOLLOW             10
#define CHASSIS_KI_V_FOLLOW             0.3
...
#define CENTER_ECD_YAW   5050         //云台yaw轴编码器归中值
#define CENTER_ECD_PITCH 4585         //云台pitch轴编码器归中值
...
/* auto速度环 */
#define YAW_KP_V_AUTO            5000  //5000
...
/* auto速度环 */
#define PITCH_KP_V_AUTO          4250// 4250
#define PITCH_KI_V_AUTO          1000  //1000 300
...
#define TRIGGER_MOTOR_60_TO_ANGLE 60
/* -------------------------------- 发射电机PID参数 ------------------------------- */
